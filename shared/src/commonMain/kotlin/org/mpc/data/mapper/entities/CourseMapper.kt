...
internal fun CourseSummary.toEntity(semester: String): CourseEntity =
    CourseEntity(
        semester = semester,
...
internal fun String.toPasswordCardType(): PasswordCardType =
    when (this) {
...
internal fun String.toCourseType(): CourseType =
    when (this) {
